    ...
    return (
        <header>
            ...
            <div className=" flex items-center bg-amazon_blue flex-grow py-2 h-20">
                ...
                {/* search */}
                <div className="hidden sm:flex items-center h-10 rounded-md cursor-pointer bg-green-700 hover:bg-green-800 flex-grow justify-between">
